...
int input_read_parameters_species(struct file_content * pfc,
  ...
  class_read_double("eta_function",pba->eta_function);
  class_read_double("alpha0_ddr",pba->alpha0_ddr);
  class_read_double("alpha1_ddr",pba->alpha1_ddr);
  class_read_double("zstar_ddr",pba->zstar_ddr);
